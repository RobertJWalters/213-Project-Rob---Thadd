...
//Delete all of this and replace with actual session logic and maybe a SessionManager class
...
if ($_POST['action'] === 'addToCart') {
    ...
    $product = $prodRepo->findProductByID($productId);

    $sM->addToCart($product);
